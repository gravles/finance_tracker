    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="card-sm">
          <div className="stat-label">Total Monthly Gross</div>
          <div className="stat-value text-white mt-1">{formatCAD(totalMonthly)}</div>
          <div className="text-xs text-gray-500 mt-1">{formatCAD(totalMonthly * 12)}/yr</div>
        </div>
        <div className="card-sm">
              ...
              {sources.map(s => (
                <tr key={s.id} className="hover:bg-gray-800/30 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right font-mono text-green-400">
                    {formatCAD(toMonthlyAmount(s.gross_cad, s.frequency))}
                  </td>
